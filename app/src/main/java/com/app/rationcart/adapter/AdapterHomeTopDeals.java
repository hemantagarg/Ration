...
public class AdapterHomeTopDeals extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterHomeTopDeals(Context context, OnCustomItemClicListener lis, ArrayList<ModelHomeData> list) {
