...
public class AdapterSubcategoriesNames extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterSubcategoriesNames(Context context, OnCustomItemClicListener lis, ArrayList<ModelHomeData> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_subcategories_names, parent, false);
